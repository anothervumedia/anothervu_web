...
(function ($, window) {
  ...
  AnotherVu.Upload = {
    init: function () {
      AnotherVu.Upload.setupCloudinaryUpload();
    },
  ...
  $(document).on('turbolinks:load', AnotherVu.Upload.init);
...
//    //code here
//    if ($('.container').first().innerWidth() > 767) {
//         $('#input').addClass('desktop-form');
//     } else {
//         $('#input').addClass('mobile-form');
//     }
// });
...
//     if ($('.container').first().innerWidth() > 767) {
//         $('#input').addClass('desktop-form');
//         $('#input').removeClass('mobile-form');
//     } else {
//         $('#input').removeClass('desktop-form');
//         $('#input').addClass('mobile-form');
//     }
// } ,300);
// // }
